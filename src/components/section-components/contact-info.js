				...
				<div className="container">
					<div className='row'>
						<div className='col-md-12'>
							<h4 className='text-center font-weight-normal'>Located conveniently at 478 Torquay Road, Area Real Estate WA offers a tailored real estate service to those who live in the 3217 area.</h4>
							<p className='text-center'>If you would like to book a sale or rental appraisal, please click here.</p>
						</div>
					</div>
				<div className="row">
