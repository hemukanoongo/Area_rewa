	...
	fetchData = async () => {
		try {
			...
			let filteredData = dataArray[0].listinglist.filter((data) => {
				console.log(data, "23")
				return data.details.saletype == this.state.filter
											...
											<div className='row'>
												{data.map((innerItem) => (
													<div key={innerItem.id} className="col-lg-4 col-sm-6 col-12">
														<div>
															<Link to={`/shop-details/${innerItem.promo.headline}/#top`}>
																<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
																	...
																	<div className="product-info">
																		...
																		<div className="product-img-location">
																			<ul>
																				<li className="go-top">
																					<Link to={`/shop-details/${innerItem.promo.headline}`}><i className="flaticon-pin" /> {innerItem.address._showaddress}</Link>
																				</li>
																			</ul>
																		</div>
